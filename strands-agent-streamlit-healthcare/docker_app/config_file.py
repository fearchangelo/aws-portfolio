class Config:
    ...
    STACK_NAME = "strands-agent-streamlit-healthcare"
    ...
    CUSTOM_HEADER_VALUE = "random-value-$TR@ND$4g3n7"    
    ...
    SECRETS_MANAGER_ID = f"{STACK_NAME}ParamCognitoSecretStrandsAgent"
